...
public class Nhap_hang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_NgayNhap.setActionCommand("<Not Set>");
        jPanel1.add(txt_NgayNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(211, 207, 280, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 1060, 300));

        jLabel8.setFont(new java.awt.Font("Segoe UI Black", 1, 30)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 51, 51));
        jLabel8.setText("KHO HÀNG");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 380, -1, -1));
        ...
        jLabel11.setText("nghìn VNĐ/đôi");
    ...
    private void btn_NhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_NhapHangActionPerformed
        if (!checkValidateForm()) {
            ...
            if (!check()) {
                ...
                Nhapcungsp();
                if (isDateValid(txt_NgayNhap)) {
                    try {
                        if (isBeforeNow(txt_NgayNhap)) {
                            boolean isExist = false;
                            for (SanPham sp : daoSP.sanphamlist) {
                                if (sp.getMaSp().equals(txt_MaSp.getText().trim()) && sp.getNgayNhap().equals(txt_NgayNhap.getText().trim())) {
                    ...
                    JOptionPane.showMessageDialog(this, "Bạn nhập sai định dạng ngày!", "Lỗi!", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    public void setModel(SanPham sp) {
        ...
        txt_NgayNhap.setText(sp.getNgayNhap());
    ...
    public void Nhapcungsp() {
        for (SanPham sp : daoSP.sanphamlist) {
            if (sp.getMaSp().equalsIgnoreCase(txt_MaSp.getText().trim()) && sp.getTenSp().equalsIgnoreCase(txt_TenSp.getText()) && sp.getNgayNhap().equals(txt_NgayNhap.getText().trim())) {
